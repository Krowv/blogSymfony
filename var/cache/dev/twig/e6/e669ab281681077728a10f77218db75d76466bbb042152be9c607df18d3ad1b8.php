...
class __TwigTemplate_99af850a0dab8e3914aebb9b0a643da06601edbe555a77bf945569fb2fe6432a extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 6
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["formArticle"]) || array_key_exists("formArticle", $context) ? $context["formArticle"] : (function () { throw new RuntimeError('Variable "formArticle" does not exist.', 6, $this->source); })()), 'form');
        echo "
";
...
<h1>Création d'articles</h1>
    ...
    {{ form(formArticle) }}
{%  endblock %}", "blog/create.html.twig", "/Users/thomasdufour/Documents/modif/blog/templates/blog/create.html.twig");
    }
}
